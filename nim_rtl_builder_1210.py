...
def parse_basic_arg(argtype, gens=None):
    ...
    string_types = ["string", "cstring", "WideCString", "TaintedString"]
...
def built_nim(filename_out, src_file, RTLfile):
    ...
    built_cmd = ["nim", "c", "-d:release", "--opt:speed",  "--passC:-ffunction-sections" ,nim_cache_str, f"-o:{filename_out}", src_file]
